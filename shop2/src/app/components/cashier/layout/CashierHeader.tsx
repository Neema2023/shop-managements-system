      ...
      <header className="bg-white border-b border-gray-200 px-4 md:px-6 py-3 md:py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div>
              <h1 className="text-lg md:text-2xl font-bold text-gray-800">Cashier Dashboard</h1>
              <p className="text-xs md:text-sm text-gray-500">Process sales and transactions</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div className="flex items-center gap-2 text-right">
              ...
              <p className="font-semibold text-gray-800 text-sm md:text-base">{cartCount}</p>
            </div>
            
            {/* Desktop: Cashier info */}
            <div className="hidden md:flex items-center gap-3">
              <div className="text-right">
                <p className="text-sm font-medium text-gray-800">{userData?.name || 'Cashier User'}</p>
                <p className="text-xs text-gray-500">{userData?.shift || 'Morning Shift'}</p>
              </div>
              <div className="w-8 h-8 md:w-10 md:h-10 bg-gradient-to-br from-green-400 to-emerald-400 rounded-full flex items-center justify-center text-white font-semibold text-sm md:text-base">
